...
<?php
echo"<p> Mostramos que cuantos <strong>tweets</strong> envió el usuario <strong> $consultarper_usuari </strong> desglosados por los días motorizados durante el evento";
?>
...
<?php
echo'<br><strong>Nota: </strong> Se eliminaron todas las cuentas oficiales de los medios de comunicación y cuentas oficiales';
?>