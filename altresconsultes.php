...
$consultaper_usari=mysql_query("SELECT DAY( created_at ) AS fecha, COUNT( * ) total_por_dia,screen_name FROM tweets WHERE `tweet_text` LIKE '%#%' AND screen_name = 'nurieteme' GROUP BY DAY( created_at ) ORDER BY DAY( created_at ) LIMIT 0 , 30");
